...
import { COLORS, FONT_FAMILY, FONT_FAMILY_MONO, PANEL_W, PANEL_H, SCENE_7_DURATION } from "../constants"
...
export const Scene7Resolution: React.FC = () => {
  ...
  const holdOpacity = interpolate(frame, [DISSOLVE_START, DISSOLVE_START + 20], [1, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  })

  // Lockup fade in
  const lockupOpacity = interpolate(frame, [LOCKUP_START, LOCKUP_START + 15], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  })

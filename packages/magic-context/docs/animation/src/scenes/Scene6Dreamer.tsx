...
import { COLORS, FONT_FAMILY, FONT_FAMILY_MONO, SCENE_6_DURATION, DREAMER_PILLS, INTRO_DURATION } from "../constants"
...
export const Scene6Dreamer: React.FC = () => {
  ...
  const nightProgress = interpolate(frame, [NIGHT_START, NIGHT_END], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  })
  const dayProgress = interpolate(frame, [DAY_START, DAY_END], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  })
  ...
  const dreamerExitP = interpolate(frame, [DREAMER_EXIT - 20, DREAMER_EXIT], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  })
  ...
  const memoryQuality = interpolate(frame, [memoryQualityStart, memoryQualityStart + 40], [72, 91], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  })
    ...
    <AbsoluteFill style={{ background }}>
      ...
      {frame >= DREAMER_ENTER && frame < DREAMER_EXIT + 20 && (
        <div style={{ position: "absolute", left: panelLeft, top: panelTop, opacity: uiOpacity }}>
          <AgentPanel type="dreamer" enterProgress={dreamerEnterP} exitProgress={dreamerExitP}>
            {/* Dreamer pills */}
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {DREAMER_PILLS.map((pill, i) => {
                ...
                return (
                  ...
                  >
                    <span style={{ fontSize: 14, color: pillColors[pill.type] }}>{pill.icon}</span>
                    <span
                      style={{
                        fontFamily: FONT_FAMILY,
                        fontSize: 10,

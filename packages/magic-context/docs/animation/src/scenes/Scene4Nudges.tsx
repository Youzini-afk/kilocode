...
import { COLORS, FONT_FAMILY, FONT_FAMILY_MONO, PANEL_W, PANEL_H, SCENE_4_DURATION, INTRO_DURATION } from "../constants"
...
export const Scene4Nudges: React.FC = () => {
  ...
  // Injection animation
  const injectProgress = interpolate(frame, [INJECT_START, INJECT_START + 20], [0, 1], {
    ...
    <AbsoluteFill style={{ background: COLORS.bg }}>
      ...
      >
        ...
        <div style={{ padding: "18px 20px", overflow: "hidden", display: "flex", flexDirection: "column", gap: 12 }}>
          {frame >= MSG1_ENTER && <SkeletonMessage widthPercent={62} role="user" enterFrame={MSG1_ENTER} tag={1} />}
          {frame >= MSG2_ENTER && (
          ...
          {frame >= MSG3_ENTER && (
            <div
              style={{
                ...
                flexDirection: "column",
                gap: 8,
                opacity: interpolate(frame, [MSG3_ENTER, MSG3_ENTER + 10], [0, 1], {
                  extrapolateLeft: "clamp",
                  extrapolateRight: "clamp",
                }),

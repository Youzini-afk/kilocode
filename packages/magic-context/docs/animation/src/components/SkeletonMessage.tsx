...
export const SkeletonMessage: React.FC<Props> = ({
  ...
  const innerColor = isUser ? `rgba(147,197,253,${0.5 - selGlow * 0.2})` : `rgba(148,163,184,${0.4 - selGlow * 0.15})`
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: 8,
          background: barColor,
          border: selGlow > 0.05 ? `1.5px solid rgba(99,102,241,${selGlow * 0.7})` : "none",
          boxShadow: selGlow > 0.15 ? `0 0 0 2px rgba(99,102,241,${selGlow * 0.18})` : "none",
          display: "flex",

...
const local = {
  ...
  "settings.providers.custom.note": "通过 Base URL 添加自定义 API 提供商。",
  "settings.providers.modeModels.description": "为特定模式覆盖默认模型。如果未设置，将使用全局默认模型。",
  "provider.custom.title": "自定义 API 提供商",
  "provider.custom.description.prefix": "配置自定义 API 提供商。请参阅",
  ...
  "provider.custom.interface.label": "接口类型",
  "provider.custom.interface.placeholder": "选择接口类型",
  ...
  "provider.custom.models.vision.label": "视觉/图像输入",
  ...
  "settings.contextEngine.configureApi": "配置 API 提供商",
  "settings.contextEngine.status.enabled": "已启用",
  ...
  "settings.contextEngine.mode.light": "轻量",
  "settings.contextEngine.mode.advanced": "高级",
  "settings.contextEngine.general.title": "基础配置",
  "settings.contextEngine.general.description": "启用 Context Engine、选择默认配置，并确认可用 API 模型。",
  "settings.contextEngine.noModels.title": "没有已配置的 API 模型",
  ...
  "settings.contextEngine.memory.title": "记忆",
  "settings.contextEngine.memory.description": "项目记忆、语义检索和嵌入设置。",
  "settings.contextEngine.memory.enabled.title": "启用记忆",
  "settings.contextEngine.memory.enabled.description": "保存可在后续会话复用的项目上下文。",
  "settings.contextEngine.loading": "加载中...",
  "settings.contextEngine.toast.saved": "Context Engine 设置已保存",
  "settings.contextEngine.error.timeout": "Magic Context 设置请求超时。",
  "settings.contextEngine.error.load": "加载 Context Engine 设置失败",
  "settings.contextEngine.error.save": "保存 Context Engine 设置失败",
  "settings.contextEngine.error.diagnose": "运行 Context Engine 诊断失败",
  "settings.contextEngine.section.expand": "展开",
  "settings.contextEngine.section.collapse": "折叠",
  "settings.contextEngine.models.title": "已配置模型",
  "settings.contextEngine.models.description": "来自已配置 Kilo API 提供商的可用模型。",
  "settings.contextEngine.models.count": "{{count}} 个模型",
  "settings.contextEngine.agents.title": "智能体",
  "settings.contextEngine.agents.description": "为 Historian、Dreamer 和 Sidekick 选择 Kilo 提供商模型。",
  "settings.contextEngine.group.memory.title": "项目记忆",
  "settings.contextEngine.group.memory.description": "控制长期记忆是否保存、注入多少，以及是否自动提升反复出现的事实。",
  "settings.contextEngine.group.embedding.title": "向量与嵌入",
  "settings.contextEngine.group.embedding.description": "配置语义检索使用的向量存储和嵌入生成方式。",
  "settings.contextEngine.group.contextReduction.title": "上下文缩减",
  "settings.contextEngine.group.contextReduction.description": "控制活跃会话里的缩减工具、执行阈值和保护范围。",
  "settings.contextEngine.group.commitTrigger.title": "提交触发",
  "settings.contextEngine.group.commitTrigger.description": "提交簇达到阈值后自动触发 Historian。",
  "settings.contextEngine.group.timeouts.title": "超时控制",
  "settings.contextEngine.group.timeouts.description": "设置长耗时模型调用的最大运行时间。",
  "settings.contextEngine.group.compressor.title": "后台压缩",
  "settings.contextEngine.group.compressor.description": "控制历史超过预算后的后台压缩行为。",
  "settings.contextEngine.group.experimental.title": "实验功能",
  "settings.contextEngine.group.experimental.description": "管理自动搜索、Git 索引、时间感知等实验能力。",
  "settings.contextEngine.historian.core": "核心",
  "settings.contextEngine.historian.twoPass.title": "双阶段清理",
  "settings.contextEngine.historian.twoPass.description": "Historian 完成后再运行一次编辑清理，移除低价值或重复记录。",
  "settings.contextEngine.historian.timeout.title": "Historian 超时毫秒数",
  "settings.contextEngine.historian.timeout.description": "每次 Historian 模型调用允许的最长运行时间。",
  "settings.contextEngine.thinking.title": "思考等级",
  "settings.contextEngine.thinking.description": "传给子智能体模型的可选推理等级。",
  "settings.contextEngine.thinking.default": "提供商默认",
  "settings.contextEngine.thinking.off": "关闭",
  ...
  "settings.contextEngine.dreamer.schedule.title": "Dreamer 运行窗口",
  "settings.contextEngine.dreamer.schedule.description": "后台规划的计划运行时间窗口，例如 02:00-06:00。",
  "settings.contextEngine.memory.budget.title": "记忆注入 Token",
  "settings.contextEngine.memory.budget.description": "从可复用项目记忆注入的最大 Token 数。",
  "settings.contextEngine.memory.autoPromote.title": "自动提升事实",
  "settings.contextEngine.memory.autoPromote.description": "自动把反复出现的会话事实提升为项目记忆。",
  "settings.contextEngine.memory.promotionThreshold.title": "提升阈值",
  "settings.contextEngine.memory.promotionThreshold.description": "记忆变为永久前需要达到的检索次数。",
  "settings.contextEngine.embedding.storage.title": "向量存储",
  "settings.contextEngine.embedding.storage.description": "Magic Context 将记忆向量保存在内置 SQLite 数据库中。",
  "settings.contextEngine.embedding.storage.sqlite": "内置 SQLite",
  "settings.contextEngine.embedding.provider.title": "嵌入提供商",
  "settings.contextEngine.embedding.provider.description": "选择如何为语义检索生成记忆嵌入。",
  "settings.contextEngine.embedding.provider.local": "本地",
  "settings.contextEngine.embedding.provider.openai-compatible": "OpenAI 兼容",
  "settings.contextEngine.embedding.provider.off": "关闭",
  "settings.contextEngine.embedding.model.title": "嵌入模型",
  "settings.contextEngine.embedding.model.description": "用于记忆搜索的本地或远程嵌入模型。",
  "settings.contextEngine.embedding.endpoint.title": "嵌入端点",
  "settings.contextEngine.embedding.endpoint.description": "OpenAI 兼容的嵌入接口地址。",
  "settings.contextEngine.embedding.apiKey.title": "嵌入 API 密钥",
  "settings.contextEngine.embedding.apiKey.description": "API 密钥或 {env:OPENAI_API_KEY} 这类配置变量。",
  "settings.contextEngine.runtime.title": "运行时",
  "settings.contextEngine.runtime.description": "活跃会话中使用的阈值和上下文缩减行为。",
  "settings.contextEngine.ctxReduce.title": "暴露 ctx_reduce",
  "settings.contextEngine.ctxReduce.description": "向模型展示 ctx_reduce 工具并启用缩减提醒。",
  "settings.contextEngine.executeThreshold.title": "执行阈值百分比",
  "settings.contextEngine.executeThreshold.description": "触发排队上下文操作的上下文使用率。",
  "settings.contextEngine.historyBudget.title": "历史预算比例",
  "settings.contextEngine.historyBudget.description": "为渲染历史保留的可用上下文比例。",
  "settings.contextEngine.protectedTags.title": "保护最近标签数",
  "settings.contextEngine.protectedTags.description": "不会被丢弃的最近消息标签数量。",
  "settings.contextEngine.compactionMarkers.title": "压缩标记",
  "settings.contextEngine.compactionMarkers.description": "Historian 发布上下文后写入 Kilo 兼容标记。",
  "settings.contextEngine.commitTrigger.title": "提交簇触发",
  "settings.contextEngine.commitTrigger.description": "提交簇积累到足够数量后运行 Historian。",
  "settings.contextEngine.commitTrigger.min.title": "最小提交簇数",
  "settings.contextEngine.commitTrigger.min.description": "触发 Historian 所需的提交簇数量。",
  "settings.contextEngine.advanced.title": "高级",
  "settings.contextEngine.advanced.description": "压缩、实验性检索和底层时间控制。",
  "settings.contextEngine.compressor.enabled.title": "后台压缩器",
  "settings.contextEngine.compressor.enabled.description": "历史超过预算时压缩较旧分段。",
  "settings.contextEngine.compressor.depth.title": "最大合并深度",
  "settings.contextEngine.compressor.depth.description": "最大压缩深度，范围 1 到 5。",
  "settings.contextEngine.experimental.autoSearch.title": "自动搜索提示",
  "settings.contextEngine.experimental.autoSearch.description": "记忆搜索命中相关上下文时追加简短提示。",
  "settings.contextEngine.experimental.gitIndex.title": "Git 提交索引",
  "settings.contextEngine.experimental.gitIndex.description": "把近期提交信息作为可搜索的上下文来源。",
  "settings.contextEngine.experimental.temporal.title": "时间感知",
  "settings.contextEngine.experimental.temporal.description": "注入时间间隔标记，让模型理解会话节奏。",
  "settings.plugins.title": "插件",
  "settings.plugins.install.url.placeholder": "https://github.com/org/kilo-plugin.git",
  "settings.plugins.install.ref.placeholder": "ref/分支（可选）",
  "settings.plugins.install.path.placeholder": "packages/plugin（可选）",
  "settings.plugins.install.button": "安装",
  "settings.plugins.install.trust": "我信任此插件来源。Git 插件可以安装依赖、运行构建脚本，并在本机执行代码。",
  "settings.plugins.loading": "正在加载插件...",
  "settings.plugins.empty": "尚未配置插件。",
  "settings.plugins.scope.global": "全局",
  "settings.plugins.scope.local": "项目",
  "settings.plugins.scope.builtin": "内置",
  "settings.plugins.source.git": "Git",
  "settings.plugins.source.npm": "npm",
  "settings.plugins.source.file": "文件",
  "settings.plugins.source.builtin": "内置",
  "settings.plugins.kind.server": "服务端",
  ...
  "settings.plugins.status.needsResolution": "需要处理",
  "settings.plugins.status.blocked": "已阻止",
  "settings.plugins.status.warning": "警告",
  "settings.plugins.restore.confirm": "{{plugin}} 曾为解决插件冲突修改 Kilo 设置。现在要恢复这些 Kilo 设置吗？",
  "settings.plugins.tooltip.openConfig": "打开配置",
  "settings.plugins.tooltip.openSettings": "打开插件设置",
  "settings.plugins.tooltip.update": "更新",
  "settings.plugins.tooltip.remove": "移除",
  "settings.plugins.settings.close": "关闭设置",
  "settings.plugins.settings.loading": "正在加载 {{plugin}} 设置...",
  "settings.plugins.progress.install.starting": "正在准备安装...",
  "settings.plugins.progress.install.downloading": "正在下载插件...",
  "settings.plugins.progress.install.refreshing": "正在刷新插件...",
  "settings.plugins.progress.enable.applying": "正在更新插件状态...",
  "settings.plugins.progress.enable.refreshing": "正在刷新插件...",
  "settings.plugins.progress.remove.removing": "正在移除插件...",
  "settings.plugins.progress.remove.refreshing": "正在刷新插件...",
  "settings.plugins.progress.update.updating": "正在更新插件...",
  "settings.plugins.progress.update.refreshing": "正在刷新插件...",
  "settings.plugins.progress.resolve.applying": "正在解决插件冲突...",
  "settings.plugins.progress.resolve.refreshing": "正在刷新插件...",
  "settings.plugins.toast.install.success": "插件已安装",
  "settings.plugins.toast.install.error": "插件安装失败",
  "settings.plugins.toast.enable.success": "插件状态已更新",
  "settings.plugins.toast.enable.error": "插件状态更新失败",
  "settings.plugins.toast.remove.success": "插件已移除",
  "settings.plugins.toast.remove.error": "插件移除失败",
  "settings.plugins.toast.update.success": "插件已更新",
  "settings.plugins.toast.update.error": "插件更新失败",
  "settings.plugins.toast.resolve.success": "插件冲突已解决",
  "settings.plugins.toast.resolve.error": "插件冲突解决失败",
  ...
  "settings.agentBehaviour.subtab.agentTeam": "智能体团队",
  ...
  "settings.agentTeam.section.collapse": "折叠",
  "settings.agentTeam.column.agent": "智能体",
  "settings.agentTeam.column.model": "模型",
  "settings.agentTeam.column.variant": "思考强度",
  "settings.agentTeam.column.temperature": "温度",
  "settings.agentTeam.column.enabled": "启用",
  "settings.agentTeam.model.default": "使用团队默认模型",
  "settings.agentTeam.fallback.title": "Fallback 模型",
  "settings.agentTeam.fallback.description": "专家模型失败时按顺序重试的模型链。只能从已配置的提供商中选择。",
  "settings.agentTeam.fallback.add": "添加 fallback 模型",
  "settings.agentTeam.fallback.remove": "移除",
  "settings.agentTeam.variant.default": "默认",
  ...
  "settings.agentTeam.skills.description": "选择此角色可以加载的内置技能或已发现技能。",
  "settings.agentTeam.skills.all": "允许所有技能",
  "settings.agentTeam.skills.empty": "尚未加载技能。请刷新技能，或在设置中添加技能路径。",
  "settings.agentTeam.skills.builtin": "内置",
  "settings.agentTeam.skills.missing": "Agent Team 推荐，但当前未发现。",
  "settings.agentTeam.mcps.placeholder": "MCP：*, !context7, github",
  "settings.agentTeam.mcps.title": "MCP 服务",
  "settings.agentTeam.mcps.description": "选择此角色可以使用的已配置 MCP 服务。",
  "settings.agentTeam.mcps.all": "允许所有已配置 MCP 服务",
  "settings.agentTeam.mcps.empty": "尚未配置 MCP 服务。",
  "settings.agentTeam.mcps.missing": "Agent Team 推荐，但当前未配置。",
  "settings.agentTeam.mcps.status.configured": "已配置",
  "settings.agentTeam.mcps.status.connected": "已连接",
  "settings.agentTeam.mcps.status.disabled": "已禁用",
  "settings.agentTeam.mcps.status.failed": "连接失败",
  "settings.agentTeam.mcps.status.needs_auth": "需要授权",
  "settings.agentTeam.mcps.status.needs_client_registration": "需要客户端注册",
  "settings.agentTeam.policy.restore": "恢复推荐",
  "settings.agentTeam.policy.recommendedActive": "推荐配置",
  "settings.agentTeam.policy.state.allow": "允许",
  "settings.agentTeam.policy.state.deny": "屏蔽",
  "settings.agentTeam.policy.state.inherit": "由全部允许",
  "settings.agentTeam.policy.state.off": "关闭",
  "settings.agentTeam.role.advanced.show": "显示策略",
  "settings.agentTeam.role.advanced.hide": "隐藏策略",
  "settings.agentTeam.role.alwaysAvailable": "始终可选",
  "settings.agentTeam.group.entry.title": "入口",
  "settings.agentTeam.group.entry.description": "选择用户如何进入团队工作流。",
  "settings.agentTeam.group.strategy.title": "设计与计划",
  "settings.agentTeam.group.strategy.description": "把大面设计和具体实施计划拆开配置。",
  "settings.agentTeam.group.discovery.title": "发现",
  "settings.agentTeam.group.discovery.description": "在决策或修改前收集代码、文档和视觉上下文。",
  "settings.agentTeam.group.execution.title": "执行",
  "settings.agentTeam.group.execution.description": "把有边界的实现工作交给合适的工程专家。",
  "settings.agentTeam.group.review.title": "审查",
  "settings.agentTeam.group.review.description": "只在风险值得时启用更深入的验收或智囊讨论。",
  "settings.agentTeam.role.secretary.title": "Secretary",
  "settings.agentTeam.role.secretary.description": "对齐用户意图，让简单任务保持快速，并把复杂工作分派给专家。",
  "settings.agentTeam.role.orchestrator.title": "Orchestrator",
  "settings.agentTeam.role.orchestrator.description":
    "指挥完整流程，快速任务直接处理，并判断何时使用 Design、Plan 或专家。",
  "settings.agentTeam.role.architect.title": "Design",
  "settings.agentTeam.role.architect.description": "负责架构、产品/系统形态、数据/API/插件边界、迁移方案和长期取舍。",
  "settings.agentTeam.role.planner.title": "Plan",
  "settings.agentTeam.role.planner.description":
    "把已确定的目标拆成可执行任务、文件边界、依赖关系、专家分工和验证检查。",
  "settings.agentTeam.role.explorer.title": "Explorer",
  "settings.agentTeam.role.explorer.description": "快速查找文件、符号、调用点和架构入口。",
  ...
  "settings.agentTeam.role.fixer.description": "执行后端、服务、CLI、配置、夹具、测试和非 UI 的边界清晰修改。",
  "settings.agentTeam.role.observer.title": "Observer",
  "settings.agentTeam.role.observer.description": "分析截图、图片、PDF、图表和可见 UI 细节。",
  "settings.agentTeam.role.council.title": "Council",
  "settings.agentTeam.role.council.description": "针对复杂、模糊、架构性或高风险决策运行独立智囊讨论。",
  "settings.agentTeam.collaboration.title": "协作",
  "settings.agentTeam.collaboration.description": "控制专家会话如何在相关任务之间复用。",
  "settings.agentTeam.sessionReuse.title": "复用专家会话",
  "settings.agentTeam.sessionReuse.description": "保留少量专家会话，让重复分工能延续上下文。",
  "settings.agentTeam.sessionReuse.max.title": "每个专家的会话数",
  "settings.agentTeam.sessionReuse.max.description": "每个专家角色最多保留的可复用会话数。",
  "settings.agentTeam.advanced.title": "高级",
  "settings.agentTeam.advanced.description": "调整子智能体运行时、Council 超时和自动继续行为。",
  "settings.agentTeam.subtask.timeout.title": "子智能体超时",
  "settings.agentTeam.subtask.timeout.description": "等待委派任务智能体的最长毫秒数。填 0 可禁用超时。",
  "settings.agentTeam.council.title": "启用 Council",
  "settings.agentTeam.council.description": "暴露可选 Council 工作流，用于审慎的多智能体决策。",
  "settings.agentTeam.council.timeout.title": "Council 超时",
  ...
  "settings.agentTeam.autoContinue.cooldown.description": "下一次自动继续前等待的毫秒数。",

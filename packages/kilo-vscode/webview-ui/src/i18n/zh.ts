...
const local = {
  ...
  "settings.agentTeam.enabled.description": "使用 Kilo 内置的专家团队处理规划、检索、实现、审查和协调。",
  "settings.agentTeam.takeover.title": "作为默认智能体",
  "settings.agentTeam.takeover.description": "未显式配置默认智能体时，新会话默认使用团队协调器。",
  "settings.agentTeam.roles.title": "专家角色",
  "settings.agentTeam.roles.description": "用排列好的选项配置协调器和专家路由，不再编辑原始 JSON。",
  ...
  "settings.agentTeam.role.orchestrator.description": "协调完整流程，并判断什么时候值得分派给专家。",
  ...
  "settings.agentTeam.role.oracle.description": "回答聚焦的技术问题，并验证架构取舍。",
  ...
  "settings.agentTeam.role.fixer.description": "执行边界清晰的代码修改并修复缺陷。",
  ...
  "settings.agentTeam.role.council.description": "针对高风险决策运行结构化多智能体评审。",

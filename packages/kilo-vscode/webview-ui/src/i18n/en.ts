export const dict = {
  ...
  "settings.providers.custom.description": "Add a custom API provider by base URL.",

  "provider.custom.title": "Custom provider",
  "provider.custom.description.prefix": "Configure a custom API provider. See the ",
  ...
  "provider.custom.interface.label": "Interface type",
  "provider.custom.interface.placeholder": "Select interface type",
  ...
  "provider.custom.models.vision.label": "Vision / image input",
  ...
  "provider.custom.error.positiveInteger": "Use a positive whole number",
  ...
  "settings.contextEngine.configureApi": "Configure API Provider",
  "settings.contextEngine.status.enabled": "Enabled",
  "settings.contextEngine.status.disabled": "Disabled",
  ...
  "settings.contextEngine.memory.title": "Memory",
  "settings.contextEngine.memory.description": "Project memory, semantic retrieval, and embedding settings.",
  "settings.contextEngine.memory.enabled.title": "Enable memory",
  "settings.contextEngine.memory.enabled.description": "Persist reusable project context for future sessions.",
  "settings.contextEngine.loading": "Loading...",
  "settings.contextEngine.toast.saved": "Context Engine settings saved",
  "settings.contextEngine.error.timeout": "Magic Context settings request timed out.",
  "settings.contextEngine.error.load": "Failed to load Context Engine settings",
  "settings.contextEngine.error.save": "Failed to save Context Engine settings",
  "settings.contextEngine.error.diagnose": "Failed to run Context Engine diagnostics",
  "settings.contextEngine.section.expand": "Expand",
  "settings.contextEngine.section.collapse": "Collapse",
  "settings.contextEngine.models.title": "Configured models",
  "settings.contextEngine.models.description": "Models available from configured Kilo API providers.",
  ...
  "settings.contextEngine.thinking.description": "Optional reasoning level passed to the subagent model.",
  "settings.contextEngine.thinking.default": "Provider default",
  "settings.contextEngine.thinking.off": "Off",
  "settings.contextEngine.thinking.minimal": "Minimal",
  "settings.contextEngine.thinking.low": "Low",
  "settings.contextEngine.thinking.medium": "Medium",
  "settings.contextEngine.thinking.high": "High",
  ...
  "settings.contextEngine.embedding.model.title": "Embedding model",
  "settings.contextEngine.embedding.model.description": "Local or remote embedding model used for memory search.",
  "settings.contextEngine.embedding.endpoint.title": "Embedding endpoint",
  "settings.contextEngine.embedding.endpoint.description": "OpenAI-compatible embeddings endpoint.",
  ...
  "settings.contextEngine.commitTrigger.min.description": "Number of commit clusters required to trigger Historian.",
  "settings.contextEngine.advanced.title": "Advanced",
  "settings.contextEngine.advanced.description": "Compression, experimental retrieval, and low-level timing controls.",
  "settings.contextEngine.compressor.enabled.title": "Background compressor",
  "settings.contextEngine.compressor.enabled.description": "Compress older compartments when history exceeds budget.",
  ...
  "settings.plugins.install.path.placeholder": "packages/plugin (optional)",
  ...
  "settings.plugins.status.needsResolution": "Needs resolution",
  "settings.plugins.status.blocked": "Blocked",
  "settings.plugins.status.warning": "Warning",
  "settings.plugins.restore.confirm":
    "{{plugin}} changed Kilo settings while resolving a plugin conflict. Restore those Kilo settings now?",
  "settings.plugins.tooltip.openConfig": "Open config",
  "settings.plugins.tooltip.openSettings": "Open plugin settings",
  "settings.plugins.tooltip.update": "Update",
  "settings.plugins.tooltip.remove": "Remove",
  "settings.plugins.settings.close": "Close settings",
  "settings.plugins.settings.loading": "Loading {{plugin}} settings...",
  "settings.plugins.progress.install.starting": "Preparing install...",
  "settings.plugins.progress.install.downloading": "Downloading plugin...",
  "settings.plugins.progress.install.refreshing": "Refreshing plugins...",
  "settings.plugins.progress.enable.applying": "Updating plugin state...",
  "settings.plugins.progress.enable.refreshing": "Refreshing plugins...",
  "settings.plugins.progress.remove.removing": "Removing plugin...",
  "settings.plugins.progress.remove.refreshing": "Refreshing plugins...",
  "settings.plugins.progress.update.updating": "Updating plugin...",
  "settings.plugins.progress.update.refreshing": "Refreshing plugins...",
  "settings.plugins.progress.resolve.applying": "Resolving plugin conflict...",
  "settings.plugins.progress.resolve.refreshing": "Refreshing plugins...",
  "settings.plugins.toast.install.success": "Plugin installed",
  "settings.plugins.toast.install.error": "Plugin install failed",
  "settings.plugins.toast.enable.success": "Plugin state updated",
  "settings.plugins.toast.enable.error": "Plugin state update failed",
  "settings.plugins.toast.remove.success": "Plugin removed",
  "settings.plugins.toast.remove.error": "Plugin removal failed",
  "settings.plugins.toast.update.success": "Plugin updated",
  "settings.plugins.toast.update.error": "Plugin update failed",
  "settings.plugins.toast.resolve.success": "Plugin conflict resolved",
  "settings.plugins.toast.resolve.error": "Plugin conflict resolution failed",
  ...
  "settings.agentTeam.skills.title": "Skills",
  "settings.agentTeam.skills.description": "Choose which built-in or discovered skills this role may load.",
  "settings.agentTeam.skills.all": "Allow all skills",
  "settings.agentTeam.skills.empty": "No skills loaded yet. Refresh skills or add skill paths in settings.",
  "settings.agentTeam.skills.builtin": "Built in",
  "settings.agentTeam.skills.missing": "Recommended by Agent Team, but not currently discovered.",
  "settings.agentTeam.mcps.placeholder": "MCPs: *, !context7, github",
  "settings.agentTeam.mcps.title": "MCP servers",
  "settings.agentTeam.mcps.description": "Choose which configured MCP servers this role may use.",
  "settings.agentTeam.mcps.all": "Allow all configured MCP servers",
  "settings.agentTeam.mcps.empty": "No MCP servers configured.",
  "settings.agentTeam.mcps.missing": "Recommended by Agent Team, but not configured.",
  "settings.agentTeam.mcps.status.configured": "Configured",
  "settings.agentTeam.mcps.status.connected": "Connected",
  "settings.agentTeam.mcps.status.disabled": "Disabled",
  "settings.agentTeam.mcps.status.failed": "Failed",
  "settings.agentTeam.mcps.status.needs_auth": "Needs auth",
  "settings.agentTeam.mcps.status.needs_client_registration": "Needs client registration",
  "settings.agentTeam.policy.restore": "Restore recommended",
  "settings.agentTeam.policy.recommendedActive": "Recommended",
  "settings.agentTeam.policy.state.allow": "Allowed",
  "settings.agentTeam.policy.state.deny": "Blocked",
  "settings.agentTeam.policy.state.inherit": "Allowed by all",
  "settings.agentTeam.policy.state.off": "Off",
  ...
  "settings.agentTeam.group.discovery.description":
    "Gather code, documentation, and visual context before decisions or edits.",
  "settings.agentTeam.group.execution.title": "Execution",
  "settings.agentTeam.group.execution.description":
    "Assign bounded implementation work to the right engineering specialist.",
  "settings.agentTeam.group.review.title": "Review",
  "settings.agentTeam.group.review.description":
    "Use deeper acceptance checks or council debate only when risk justifies it.",
  ...
  "settings.providers.custom.note": "Add a custom API provider by base URL.",

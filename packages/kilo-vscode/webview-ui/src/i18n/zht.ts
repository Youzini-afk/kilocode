...
const local = {
  ...
  "settings.providers.custom.note": "透過 Base URL 新增自訂 API 供應商。",
  "settings.providers.modeModels.description": "為特定模式覆寫預設模型。如果未設定，將使用全域預設模型。",
  "provider.custom.title": "自訂 API 提供商",
  "provider.custom.description.prefix": "設定自訂 API 提供商。請參閱",
  ...
  "provider.custom.interface.label": "介面類型",
  "provider.custom.interface.placeholder": "選擇介面類型",
  "provider.custom.interface.google-generative-ai.label": "Gemini API",
  "provider.custom.interface.openai-compatible.label": "OpenAI API",
  "provider.custom.interface.openai-responses.label": "OpenAI Responses API",
  "provider.custom.interface.anthropic.label": "Anthropic API",
  ...
  "provider.custom.error.positiveInteger": "請輸入正整數",
  ...
  "settings.contextEngine.description": "Kilo 內建的上下文規劃、記憶與助手能力，用於長任務和長期專案上下文。",
  "settings.contextEngine.refresh": "重新整理",
  "settings.contextEngine.diagnose": "診斷",
  "settings.contextEngine.reset": "重設",
  "settings.contextEngine.save": "儲存",
  "settings.contextEngine.configureApi": "設定 API 提供商",
  "settings.contextEngine.status.enabled": "已啟用",
  "settings.contextEngine.status.disabled": "已停用",
  "settings.contextEngine.diagnose.title": "Context Engine 診斷",
  "settings.contextEngine.diagnose.description": "狀態：{{status}} · 可用 API 模型：{{models}}",
  "settings.contextEngine.enabled.title": "啟用 Context Engine",
  "settings.contextEngine.enabled.description":
    "為目前工作區啟用 Kilo 內建 Context Engine。儲存後會由它接管長上下文處理，並關閉原生閾值自動總結。",
  "settings.contextEngine.mode.title": "預設設定",
  "settings.contextEngine.mode.description": "選擇預設啟用多少 Context Engine 自動化能力。",
  "settings.contextEngine.mode.recommended": "建議",
  "settings.contextEngine.mode.light": "輕量",
  "settings.contextEngine.mode.advanced": "進階",
  "settings.contextEngine.general.title": "基礎設定",
  "settings.contextEngine.general.description": "啟用 Context Engine、選擇預設設定，並確認可用 API 模型。",
  "settings.contextEngine.noModels.title": "沒有已設定的 API 模型",
  "settings.contextEngine.noModels.description": "請先設定 API 提供商，然後在這裡選擇模型。",
  ...
  "settings.contextEngine.historian.description":
    "為長對話建立可延續的歷史記錄：保留關鍵決策、限制、已完成工作和重要專案上下文，避免壓縮後遺失。",
  "settings.contextEngine.dreamer.title": "Dreamer",
  "settings.contextEngine.dreamer.description":
    "根據目前專案上下文提前規劃：拆出下一步行動、提示潛在風險，並把模糊意圖整理成可執行待辦。",
  "settings.contextEngine.sidekick.title": "Sidekick",
  "settings.contextEngine.sidekick.description":
    "在目前對話中提供輕量輔助：檢索相關上下文、補齊資訊缺口，減少反覆解釋同一背景。",
  "settings.contextEngine.model.title": "模型",
  "settings.contextEngine.model.description": "從已設定的 Kilo API 提供商中選擇模型。",
  "settings.contextEngine.model.default": "使用 Kilo 預設模型",
  "settings.contextEngine.memory.title": "記憶",
  "settings.contextEngine.memory.description": "專案記憶、語義檢索和嵌入設定。",
  "settings.contextEngine.memory.enabled.title": "啟用記憶",
  "settings.contextEngine.memory.enabled.description": "儲存可在後續對話重複使用的專案上下文。",
  "settings.contextEngine.loading": "載入中...",
  "settings.contextEngine.toast.saved": "Context Engine 設定已儲存",
  "settings.contextEngine.error.timeout": "Magic Context 設定請求逾時。",
  "settings.contextEngine.error.load": "載入 Context Engine 設定失敗",
  "settings.contextEngine.error.save": "儲存 Context Engine 設定失敗",
  "settings.contextEngine.error.diagnose": "執行 Context Engine 診斷失敗",
  "settings.contextEngine.section.expand": "展開",
  "settings.contextEngine.section.collapse": "摺疊",
  "settings.contextEngine.models.title": "已設定模型",
  "settings.contextEngine.models.description": "來自已設定 Kilo API 提供商的可用模型。",
  "settings.contextEngine.models.count": "{{count}} 個模型",
  "settings.contextEngine.agents.title": "智慧體",
  "settings.contextEngine.agents.description": "為 Historian、Dreamer 和 Sidekick 選擇 Kilo 提供商模型。",
  "settings.contextEngine.group.memory.title": "專案記憶",
  "settings.contextEngine.group.memory.description": "控制長期記憶是否儲存、注入多少，以及是否自動提升反覆出現的事實。",
  "settings.contextEngine.group.embedding.title": "向量與嵌入",
  "settings.contextEngine.group.embedding.description": "設定語義檢索使用的向量儲存和嵌入產生方式。",
  "settings.contextEngine.group.contextReduction.title": "上下文縮減",
  "settings.contextEngine.group.contextReduction.description": "控制活躍對話裡的縮減工具、執行閾值和保護範圍。",
  "settings.contextEngine.group.commitTrigger.title": "提交觸發",
  "settings.contextEngine.group.commitTrigger.description": "提交簇達到閾值後自動觸發 Historian。",
  "settings.contextEngine.group.timeouts.title": "逾時控制",
  "settings.contextEngine.group.timeouts.description": "設定長耗時模型呼叫的最長執行時間。",
  "settings.contextEngine.group.compressor.title": "背景壓縮",
  "settings.contextEngine.group.compressor.description": "控制歷史超過預算後的背景壓縮行為。",
  "settings.contextEngine.group.experimental.title": "實驗功能",
  "settings.contextEngine.group.experimental.description": "管理自動搜尋、Git 索引、時間感知等實驗能力。",
  "settings.contextEngine.historian.core": "核心",
  "settings.contextEngine.historian.twoPass.title": "雙階段清理",
  "settings.contextEngine.historian.twoPass.description": "Historian 完成後再執行一次編輯清理，移除低價值或重複記錄。",
  "settings.contextEngine.historian.timeout.title": "Historian 逾時毫秒數",
  "settings.contextEngine.historian.timeout.description": "每次 Historian 模型呼叫允許的最長執行時間。",
  "settings.contextEngine.thinking.title": "思考等級",
  "settings.contextEngine.thinking.description": "傳給子智慧體模型的可選推理等級。",
  "settings.contextEngine.thinking.default": "提供商預設",
  "settings.contextEngine.thinking.off": "關閉",
  "settings.contextEngine.thinking.minimal": "最小",
  "settings.contextEngine.thinking.low": "低",
  "settings.contextEngine.thinking.medium": "中",
  "settings.contextEngine.thinking.high": "高",
  "settings.contextEngine.thinking.xhigh": "超高",
  "settings.contextEngine.thinking.max": "最大",
  "settings.contextEngine.dreamer.schedule.title": "Dreamer 執行視窗",
  "settings.contextEngine.dreamer.schedule.description": "背景規劃的排程執行時間視窗，例如 02:00-06:00。",
  "settings.contextEngine.memory.budget.title": "記憶注入 Token",
  "settings.contextEngine.memory.budget.description": "從可重複使用專案記憶注入的最大 Token 數。",
  "settings.contextEngine.memory.autoPromote.title": "自動提升事實",
  "settings.contextEngine.memory.autoPromote.description": "自動把反覆出現的對話事實提升為專案記憶。",
  "settings.contextEngine.memory.promotionThreshold.title": "提升閾值",
  "settings.contextEngine.memory.promotionThreshold.description": "記憶變為永久前需要達到的檢索次數。",
  "settings.contextEngine.embedding.storage.title": "向量儲存",
  "settings.contextEngine.embedding.storage.description": "Magic Context 將記憶向量保存在內建 SQLite 資料庫中。",
  "settings.contextEngine.embedding.storage.sqlite": "內建 SQLite",
  "settings.contextEngine.embedding.provider.title": "嵌入提供商",
  "settings.contextEngine.embedding.provider.description": "選擇如何為語義檢索產生記憶嵌入。",
  "settings.contextEngine.embedding.provider.local": "本機",
  "settings.contextEngine.embedding.provider.openai-compatible": "OpenAI 相容",
  "settings.contextEngine.embedding.provider.off": "關閉",
  "settings.contextEngine.embedding.model.title": "嵌入模型",
  "settings.contextEngine.embedding.model.description": "用於記憶搜尋的本機或遠端嵌入模型。",
  "settings.contextEngine.embedding.endpoint.title": "嵌入端點",
  "settings.contextEngine.embedding.endpoint.description": "OpenAI 相容的嵌入介面位址。",
  "settings.contextEngine.embedding.apiKey.title": "嵌入 API 金鑰",
  "settings.contextEngine.embedding.apiKey.description": "API 金鑰或 {env:OPENAI_API_KEY} 這類設定變數。",
  "settings.contextEngine.runtime.title": "執行階段",
  "settings.contextEngine.runtime.description": "活躍對話中使用的閾值和上下文縮減行為。",
  "settings.contextEngine.ctxReduce.title": "暴露 ctx_reduce",
  "settings.contextEngine.ctxReduce.description": "向模型展示 ctx_reduce 工具並啟用縮減提醒。",
  "settings.contextEngine.executeThreshold.title": "執行閾值百分比",
  "settings.contextEngine.executeThreshold.description": "觸發佇列上下文操作的上下文使用率。",
  "settings.contextEngine.historyBudget.title": "歷史預算比例",
  "settings.contextEngine.historyBudget.description": "為渲染歷史保留的可用上下文比例。",
  "settings.contextEngine.protectedTags.title": "保護最近標籤數",
  "settings.contextEngine.protectedTags.description": "不會被丟棄的最近訊息標籤數量。",
  "settings.contextEngine.compactionMarkers.title": "壓縮標記",
  "settings.contextEngine.compactionMarkers.description": "Historian 發布上下文後寫入 Kilo 相容標記。",
  "settings.contextEngine.commitTrigger.title": "提交簇觸發",
  "settings.contextEngine.commitTrigger.description": "提交簇累積到足夠數量後執行 Historian。",
  "settings.contextEngine.commitTrigger.min.title": "最小提交簇數",
  "settings.contextEngine.commitTrigger.min.description": "觸發 Historian 所需的提交簇數量。",
  "settings.contextEngine.advanced.title": "進階",
  "settings.contextEngine.advanced.description": "壓縮、實驗性檢索和底層時間控制。",
  "settings.contextEngine.compressor.enabled.title": "背景壓縮器",
  "settings.contextEngine.compressor.enabled.description": "歷史超過預算時壓縮較舊分段。",
  "settings.contextEngine.compressor.depth.title": "最大合併深度",
  "settings.contextEngine.compressor.depth.description": "最大壓縮深度，範圍 1 到 5。",
  "settings.contextEngine.experimental.autoSearch.title": "自動搜尋提示",
  "settings.contextEngine.experimental.autoSearch.description": "記憶搜尋命中相關上下文時追加簡短提示。",
  "settings.contextEngine.experimental.gitIndex.title": "Git 提交索引",
  "settings.contextEngine.experimental.gitIndex.description": "把近期提交資訊作為可搜尋的上下文來源。",
  "settings.contextEngine.experimental.temporal.title": "時間感知",
  "settings.contextEngine.experimental.temporal.description": "注入時間間隔標記，讓模型理解對話節奏。",
  "settings.plugins.title": "外掛程式",
  "settings.plugins.install.url.placeholder": "https://github.com/org/kilo-plugin.git",
  "settings.plugins.install.ref.placeholder": "ref/分支（可選）",
  "settings.plugins.install.path.placeholder": "packages/plugin（可選）",
  "settings.plugins.install.button": "安裝",
  "settings.plugins.install.trust":
    "我信任此外掛程式來源。Git 外掛程式可以安裝相依套件、執行建置腳本，並在本機執行程式碼。",
  "settings.plugins.loading": "正在載入外掛程式...",
  "settings.plugins.empty": "尚未設定外掛程式。",
  "settings.plugins.scope.global": "全域",
  "settings.plugins.scope.local": "專案",
  "settings.plugins.scope.builtin": "內建",
  "settings.plugins.source.git": "Git",
  "settings.plugins.source.npm": "npm",
  "settings.plugins.source.file": "檔案",
  "settings.plugins.source.builtin": "內建",
  "settings.plugins.kind.server": "伺服端",
  "settings.plugins.kind.tui": "TUI",
  "settings.plugins.version": "v{{version}}",
  "settings.plugins.tooltip.openConfig": "開啟設定檔",
  "settings.plugins.tooltip.openSettings": "開啟外掛程式設定",
  "settings.plugins.tooltip.update": "更新",
  "settings.plugins.tooltip.remove": "移除",
  "settings.plugins.settings.close": "關閉設定",
  "settings.plugins.settings.loading": "正在載入 {{plugin}} 設定...",
  "settings.plugins.progress.install.starting": "正在準備安裝...",
  "settings.plugins.progress.install.downloading": "正在下載外掛程式...",
  "settings.plugins.progress.install.refreshing": "正在重新整理外掛程式...",
  "settings.plugins.progress.enable.applying": "正在更新外掛程式狀態...",
  "settings.plugins.progress.enable.refreshing": "正在重新整理外掛程式...",
  "settings.plugins.progress.remove.removing": "正在移除外掛程式...",
  "settings.plugins.progress.remove.refreshing": "正在重新整理外掛程式...",
  "settings.plugins.progress.update.updating": "正在更新外掛程式...",
  "settings.plugins.progress.update.refreshing": "正在重新整理外掛程式...",
  "settings.plugins.progress.resolve.applying": "正在解決外掛程式衝突...",
  "settings.plugins.progress.resolve.refreshing": "正在重新整理外掛程式...",
  "settings.plugins.toast.install.success": "外掛程式已安裝",
  "settings.plugins.toast.install.error": "外掛程式安裝失敗",
  "settings.plugins.toast.enable.success": "外掛程式狀態已更新",
  "settings.plugins.toast.enable.error": "外掛程式狀態更新失敗",
  "settings.plugins.toast.remove.success": "外掛程式已移除",
  "settings.plugins.toast.remove.error": "外掛程式移除失敗",
  "settings.plugins.toast.update.success": "外掛程式已更新",
  "settings.plugins.toast.update.error": "外掛程式更新失敗",
  ...
  "settings.agentBehaviour.subtab.agentTeam": "智慧體團隊",
  ...
  "settings.agentTeam.section.collapse": "收合",
  "settings.agentTeam.column.agent": "智慧體",
  "settings.agentTeam.column.model": "模型",
  "settings.agentTeam.column.variant": "思考強度",
  "settings.agentTeam.column.temperature": "溫度",
  "settings.agentTeam.column.enabled": "啟用",
  "settings.agentTeam.model.default": "使用團隊預設模型",
  "settings.agentTeam.fallback.title": "Fallback 模型",
  "settings.agentTeam.fallback.description": "專家模型失敗時依序重試的模型鏈。只能從已設定的提供商中選擇。",
  "settings.agentTeam.fallback.add": "新增 fallback 模型",
  "settings.agentTeam.fallback.remove": "移除",
  "settings.agentTeam.variant.default": "預設",
  "settings.agentTeam.variant.low": "低",
  ...
  "settings.agentTeam.skills.placeholder": "技能：*, !imagegen, browser-use",
  "settings.agentTeam.skills.title": "技能",
  "settings.agentTeam.skills.description": "選擇此角色可以載入的內建技能或已發現技能。",
  "settings.agentTeam.skills.all": "允許所有技能",
  "settings.agentTeam.skills.empty": "尚未載入技能。請重新整理技能，或在設定中加入技能路徑。",
  "settings.agentTeam.skills.builtin": "內建",
  "settings.agentTeam.skills.missing": "Agent Team 建議，但目前未發現。",
  "settings.agentTeam.mcps.placeholder": "MCP：*, !context7, github",
  "settings.agentTeam.mcps.title": "MCP 服務",
  "settings.agentTeam.mcps.description": "選擇此角色可以使用的已設定 MCP 服務。",
  "settings.agentTeam.mcps.all": "允許所有已設定 MCP 服務",
  "settings.agentTeam.mcps.empty": "尚未設定 MCP 服務。",
  "settings.agentTeam.mcps.missing": "Agent Team 建議，但目前未設定。",
  "settings.agentTeam.mcps.status.configured": "已設定",
  "settings.agentTeam.mcps.status.connected": "已連線",
  "settings.agentTeam.mcps.status.disabled": "已停用",
  "settings.agentTeam.mcps.status.failed": "連線失敗",
  "settings.agentTeam.mcps.status.needs_auth": "需要授權",
  "settings.agentTeam.mcps.status.needs_client_registration": "需要客戶端註冊",
  "settings.agentTeam.policy.restore": "恢復建議",
  "settings.agentTeam.policy.recommendedActive": "建議設定",
  "settings.agentTeam.policy.state.allow": "允許",
  "settings.agentTeam.policy.state.deny": "封鎖",
  "settings.agentTeam.policy.state.inherit": "由全部允許",
  "settings.agentTeam.policy.state.off": "關閉",
  "settings.agentTeam.role.advanced.show": "顯示策略",
  "settings.agentTeam.role.advanced.hide": "隱藏策略",
  "settings.agentTeam.role.alwaysAvailable": "始終可選",
  "settings.agentTeam.group.entry.title": "入口",
  "settings.agentTeam.group.entry.description": "選擇使用者如何進入團隊工作流。",
  "settings.agentTeam.group.strategy.title": "設計與計劃",
  "settings.agentTeam.group.strategy.description": "把大面設計和具體實施計劃拆開設定。",
  "settings.agentTeam.group.discovery.title": "發現",
  "settings.agentTeam.group.discovery.description": "在決策或修改前收集程式碼、文件和視覺上下文。",
  "settings.agentTeam.group.execution.title": "執行",
  "settings.agentTeam.group.execution.description": "把有邊界的實作工作交給合適的工程專家。",
  "settings.agentTeam.group.review.title": "審查",
  "settings.agentTeam.group.review.description": "只在風險值得時啟用更深入的驗收或智囊討論。",
  "settings.agentTeam.role.secretary.title": "Secretary",
  "settings.agentTeam.role.secretary.description": "對齊使用者意圖，讓簡單任務保持快速，並把複雜工作分派給專家。",
  "settings.agentTeam.role.orchestrator.title": "Orchestrator",
  "settings.agentTeam.role.orchestrator.description":
    "指揮完整流程，快速任務直接處理，並判斷何時使用 Design、Plan 或專家。",
  "settings.agentTeam.role.architect.title": "Design",
  "settings.agentTeam.role.architect.description": "負責架構、產品/系統形態、資料/API/外掛邊界、遷移方案和長期取捨。",
  "settings.agentTeam.role.planner.title": "Plan",
  "settings.agentTeam.role.planner.description":
    "把已確定的目標拆成可執行任務、檔案邊界、依賴關係、專家分工和驗證檢查。",
  "settings.agentTeam.role.explorer.title": "Explorer",
  "settings.agentTeam.role.explorer.description": "快速查找檔案、符號、呼叫點和架構入口。",
  ...
  "settings.agentTeam.role.observer.description": "分析截圖、圖片、PDF、圖表和可見 UI 細節。",
  "settings.agentTeam.role.council.title": "Council",
  "settings.agentTeam.role.council.description": "針對高風險決策執行結構化多智慧體審查。",
  "settings.agentTeam.collaboration.title": "協作",
  "settings.agentTeam.collaboration.description": "控制專家對話如何在相關任務之間重用。",
  "settings.agentTeam.sessionReuse.title": "重用專家對話",
  "settings.agentTeam.sessionReuse.description": "保留少量專家對話，讓重複分工能延續上下文。",
  "settings.agentTeam.sessionReuse.max.title": "每個專家的對話數",
  "settings.agentTeam.sessionReuse.max.description": "每個專家角色最多保留的可重用對話數。",
  "settings.agentTeam.advanced.title": "進階",
  "settings.agentTeam.advanced.description": "調整子智慧體執行、Council 逾時和自動繼續行為。",
  "settings.agentTeam.subtask.timeout.title": "子智慧體逾時",
  "settings.agentTeam.subtask.timeout.description": "等待委派任務智慧體的最長毫秒數。填 0 可停用逾時。",
  "settings.agentTeam.council.title": "啟用 Council",
  "settings.agentTeam.council.description": "暴露可選 Council 工作流，用於審慎的多智慧體決策。",
  "settings.agentTeam.council.timeout.title": "Council 逾時",
  "settings.agentTeam.council.timeout.description": "等待 Council 成員的最長毫秒數。",
  "settings.agentTeam.autoContinue.title": "自動繼續",
  "settings.agentTeam.autoContinue.description": "允許團隊協調器在安全時自動繼續有邊界的工作。",
  "settings.agentTeam.autoContinue.autoEnable.title": "依 TODO 自動啟用",
  "settings.agentTeam.autoContinue.autoEnable.description":
    "在自動繼續關閉時，僅當對話有足夠未完成 TODO 時自動啟用繼續。",
  "settings.agentTeam.autoContinue.threshold.title": "TODO 閾值",
  "settings.agentTeam.autoContinue.threshold.description": "觸發自動啟用所需的最少未完成 TODO 數量。",
  "settings.agentTeam.autoContinue.max.title": "最大繼續次數",
  "settings.agentTeam.autoContinue.max.description": "每個對話最多自動繼續的次數。",
  "settings.agentTeam.autoContinue.cooldown.title": "繼續間隔",
  "settings.agentTeam.autoContinue.cooldown.description": "下一次自動繼續前等待的毫秒數。",

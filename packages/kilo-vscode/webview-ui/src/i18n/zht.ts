...
const local = {
  ...
  "settings.agentTeam.takeover.description": "未明確設定預設智慧體時，新對話預設使用團隊協調器。",
  "settings.agentTeam.roles.title": "專家角色",
  "settings.agentTeam.roles.description": "用排列好的選項設定協調器和專家路由，不再編輯原始 JSON。",
  ...
  "settings.agentTeam.role.orchestrator.description": "協調完整流程，並判斷何時值得分派給專家。",
